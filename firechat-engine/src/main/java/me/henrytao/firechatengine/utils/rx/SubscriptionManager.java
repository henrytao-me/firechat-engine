...
public class SubscriptionManager implements ISubscriptionManager {
  ...
  public void manageSubscription(Subscription subscription) {
    manageSubscription(subscription, UnsubscribeLifeCycle.NONE);
  }
  ...
  @Override
  public void manageSubscription(String id, Subscription subscription) {
    manageSubscription(id, subscription, UnsubscribeLifeCycle.NONE);
  }
