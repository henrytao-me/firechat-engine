...
public class Transformer {
  ...
  private static SchedulerManager sJobExecutorScheduler = new SchedulerManager(() -> Schedulers.from(JobExecutor.getInstance()));
  ...
  public static <T> Observable.Transformer<T, T> applyJobExecutorScheduler() {
    return observable -> observable
        .subscribeOn(sJobExecutorScheduler.get())
        .observeOn(sMainThreadScheduler.get());
  }
  ...
  public static void overrideJobExecutorScheduler(Scheduler scheduler) {
    sJobExecutorScheduler.set(scheduler);
  }
  ...
  public static void resetJobExecutorScheduler() {
    sJobExecutorScheduler.reset();
  }
