...
public class Ln {
  ...
  protected static void d(String tag, Throwable throwable) {
    if (DEBUG) {
  ...
  protected static void e(String tag, Throwable throwable) {
    if (DEBUG) {
  ...
  protected static void i(String tag, Throwable throwable) {
    if (DEBUG) {
  ...
  protected static void v(String tag, Throwable throwable) {
    if (DEBUG) {
